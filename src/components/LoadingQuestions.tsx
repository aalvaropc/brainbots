...
const loadingTexts = [
"Generando preguntas...",
"Liberando el poder de la curiosidad...",
"Sumergiéndonos en el océano de preguntas...",
"Aprovechando el conocimiento colectivo del cosmos...",
"Encendiendo la llama del asombro y la exploración...",
];
